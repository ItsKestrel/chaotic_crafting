#seat based spawning
#function chaotic_crafting:spawn_customer/spawn_seat_1
...
execute as @e[type=marker,tag=cc_customer_spawn] at @s run loot spawn ~ ~ ~ loot chaotic_crafting:menu_day_1
execute as @e[type=marker,tag=cc_customer_spawn] at @s run function chaotic_crafting:spawn_customer/add_trade with entity @e[type=item,distance=..2,limit=1] Item.components."minecraft:custom_data"
