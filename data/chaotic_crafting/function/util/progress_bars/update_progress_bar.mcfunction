scoreboard players add @s cc_progress_bars 1

scoreboard players operation $tempValue util = @s cc_progress_bars
scoreboard players operation $tempValue util *= #100 cc_consts
execute on vehicle if entity @s[tag=has_progress_bar,tag=crafter_lvl1] run scoreboard players operation $tempValue util /= $level_1_speed cc_settings
execute on vehicle if entity @s[tag=has_progress_bar,tag=crafter_lvl2] run scoreboard players operation $tempValue util /= $level_2_speed cc_settings
execute on vehicle if entity @s[tag=has_progress_bar,tag=crafter_lvl3] run scoreboard players operation $tempValue util /= $level_3_speed cc_settings
...
execute if score $tempValue util matches 100 run execute if score $day_active cc_settings matches 1 run execute on vehicle at @s run function chaotic_crafting:functional_blocks/activate_crafter

execute if score $tempValue util matches 100 run scoreboard players set @s cc_progress_bars 0